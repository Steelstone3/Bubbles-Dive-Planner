...
public class DiveProfileStagesCommandShould
{
    [Fact]
    public void Run()
    {
        ...
        DiveStage expectedDiveStage = new()
        {
            DiveModel = diveModel,
            DiveStep = diveStep,
            Cylinder = cylinder,
        ...
        IDiveProfileStagesCommand diveProfileStagesCommand = new DiveProfileStagesCommand();

...
pub struct GasMixtureReadOnlyView<'a> {
    ...
    pub oxygen_read_only_input: Text<'a>,
    pub helium_read_only_text: Text<'a>,
    pub helium_read_only_input: Text<'a>,
...
impl GasMixtureReadOnlyView<'_> {
    pub fn new(dive_planner: &DivePlanner) -> Self {
        Self {
            ...
            oxygen_read_only_input: text(dive_planner.dive_stage.cylinder.gas_mixture.oxygen),
            helium_read_only_text: text("Helium (%)"),
            helium_read_only_input: text(dive_planner.dive_stage.cylinder.gas_mixture.helium),
            nitrogen_read_only_text: text("Nitrogen (%)"),
            nitrogen_read_only_input: text(dive_planner.dive_stage.cylinder.gas_mixture.nitrogen),
        }
    }
}

...
pub fn calculate_ambient_pressures(
    ...
    DiveProfile {
        ...
        tolerated_ambient_pressure: dive_profile_model.tolerated_ambient_pressure.clone(),
        tolerated_surface_pressure: dive_profile_model.tolerated_surface_pressure.clone(),
    }
}

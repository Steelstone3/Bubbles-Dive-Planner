use crate::{
    controllers::dive_profile::dive_stage,
    models::{
...
mod dive_stage_should {
    ...
    fn test_calculate_decompression_dive_step() {
        // Given
        let expected_decompression_steps = DiveStep::new(50, 10);
        let dive_stage = dive_stage_test_fixture();

        // When
        let decompression_steps = dive_stage.calculate_decompression_dive_step();
    ...
    fn test_calculate_decompression_dive_steps() {
        // Given
        let expected_decompression_steps = vec![DiveStep::new(50, 10)];
        let dive_stage = dive_stage_test_fixture();

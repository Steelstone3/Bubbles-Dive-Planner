...
mod dive_planner_messages_should {
    ...
    fn test_decompression_profile_on_clicked() {
        ...
        let dive_profile_1 = DiveProfile {
            ...
            tissue_pressure: TissuePressure::new(vec![3.1589808,
2.5964227,
2.15595,
1.8098811,
1.5372281,
...
0.82667166,], vec![  0.43418437,
 ...
 0.85887676,
 0.8441625,]),
            tolerated_ambient_pressure: ToleratedAmbientPressure::new(vec![1.128468,
1.2798394,
1.180643,
1.0529338,
0.8982601,

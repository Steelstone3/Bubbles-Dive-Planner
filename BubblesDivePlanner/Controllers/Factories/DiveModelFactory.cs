public class DiveModelFactory : IDiveModelFactory
{
    public DiveModel CreateUsnRevisionSix()
    {
    ...
    public DiveModel CreateZhl16Buhlmann()
    {
        ...
        return new DiveModel()
        {
            ...
            AValuesNitrogen = new float[COMPARTMENT_COUNT] { 1.2559F, 1.0000F, 0.8618F, 0.7562F, 0.6667F, 0.5600F, 0.4947F, 0.4500F, 0.4187F, 0.3798F, 0.3497F, 0.3223F, 0.2850F, 0.2737F, 0.2523F, 0.2327F },
            BValuesNitrogen = new float[COMPARTMENT_COUNT] { 0.5050F, 0.6514F, 0.7222F, 0.7825F, 0.8126F, 0.8434F, 0.8693F, 0.8910F, 0.9092F, 0.9222F, 0.9319F, 0.9403F, 0.9477F, 0.9544F, 0.9602F, 0.9653F },
            AValuesHelium = new float[COMPARTMENT_COUNT] { 1.7424F, 1.3830F, 1.1919F, 1.0458F, 0.9220F, 0.8205F, 0.7305F, 0.6502F, 0.5950F, 0.5545F, 0.5333F, 0.5189F, 0.5181F, 0.5176F, 0.5172F, 0.5119F },
            BValuesHelium = new float[COMPARTMENT_COUNT] { 0.4245F, 0.5747F, 0.6527F, 0.7223F, 0.7582F, 0.7957F, 0.8279F, 0.8553F, 0.8757F, 0.8903F, 0.8997F, 0.9073F, 0.9122F, 0.9171F, 0.9217F, 0.9267F },
            DiveModelProfile = new DiveModelProfile(COMPARTMENT_COUNT),
        };
    }
}

public interface IDiveModelFactory
{
    DiveModel CreateZhl16Buhlmann();
    DiveModel CreateUsnRevisionSix();
}